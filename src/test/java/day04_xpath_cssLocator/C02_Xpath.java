 ...
 */
    public static void main(String[] args) throws InterruptedException {
        ...
        //2- Add Element butonuna basin
      //  driver.findElement(By.xpath("//button[@onclick='addElement()']")).click(); // boylede olur
        driver.findElement(By.xpath("//button[text()='Add Element']")).click(); //buton uzerindeki yazi ile
