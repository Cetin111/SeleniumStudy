...
public class C04_RelativeXpath {
    public static void main(String[] args) {
        //locate edilemeyecek bir durum olursa kullanilir. selenyum4 ile yeni cikmis.
        ...
        //mountie bostonwebelementinin altinda, sailor un solunda diye tarif ettik bu sekilde locate ettik
